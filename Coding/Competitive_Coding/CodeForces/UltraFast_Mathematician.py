...
# The contestants should write a new number corresponding to the given pair of numbers. The rule is simple:
...
# Shapur made many numbers and first tried his own speed. He saw that he can perform these operations on numbers
# of length ∞ (length of a number is number of digits in it) in a glance! He always gives correct answers so he expects
# the contestants to give correct answers, too. He is a good fellow so he won't give anyone very big numbers and
# he always gives one person numbers of same length.

# Now you are going to take part in Shapur's contest. See if you are faster and more accurate.

# Input
# There are two lines in each input. Each of them contains a single number. It is guaranteed that the numbers
# are made from 0 and 1 only and that their length is same. The numbers may start with 0.
