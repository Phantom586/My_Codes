# Vasya works as a DJ in the best Berland nightclub, and he often uses dubstep music in his performance. Recently, he
...
# Note
# In the first sample: "WUBWUBABCWUB" = "WUB" + "WUB" + "ABC" + "WUB". That means that the song originally consisted of
# a single word "ABC", and all words "WUB" were added by Vasya.

# In the second sample Vasya added a single word "WUB" between all neighbouring words, in the beginning and in the end,
# except for words "ARE" and "THE" — between them Vasya added two "WUB".


song = input()
orig_lst = song.split("WUB")
orig_song = ""
for i in orig_lst:
    if i != '':
        orig_song += i + " "
print(orig_song.rstrip())