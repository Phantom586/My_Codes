...
# where x is a prime number, and next day they beat exactly y Roman soldiers, where y is the next prime number after x,
# then it's time to wait for Armageddon, for nothing can shut Kakofonix up while he sings his infernal song.

# Yesterday the Gauls beat n Roman soldiers and it turned out that the number n was prime! Today their victims were
# a troop of m Romans (m > n). Determine whether the Gauls should wait for the black day after today's
# victory of Asterix and Obelix?
